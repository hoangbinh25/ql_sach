...
//             Định dạng ngày tháng theo kiểu yyyy-MM-dd
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txt_namSX, javax.swing.GroupLayout.PREFERRED_SIZE, 281, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btn_themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_themActionPerformed
        ...
        try (Connection conn = ConnectToSQLServer.getConnection()) {
            ...
            ps.setDate(5, sach.getNamXB(namXB)); // Chuyển đổi Date sang java.sql.Date
    ...
    private void btn_suaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_suaActionPerformed
        ...
        try (Connection conn = ConnectToSQLServer.getConnection()) {
            ...
            ps.setInt(3, sach.getMa_theloai());
            ps.setInt(4, sach.getMa_nhaXB());
            ps.setString(5, sach.getNamXB()); // Chuyển đổi Date sang java.sql.Date
            int maSach = Integer.parseInt(txt_masach.getText());
            ps.setInt(6, maSach);
            // Thực thi câu truy vấn
            int rowsAffected = ps.executeUpdate();
